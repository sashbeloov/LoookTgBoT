...
#     #     await candies(message)
#     # elif message.text == "🧸BOLALAR MENYUSI":
#     #     await kids(message)
#     # elif message.text == "🍕PIZZA":
#     #     await pizza(message)
#     # elif message.text == "🌯SPINNERLAR":
#     #     await spinner(message)
#     # elif message.text == "🥗SALATLAR":
#     #     await salat(message)
#     # elif message.text == "🥤🍟KOMBO":
#     #     await kombo(message)
#     # elif message.text == "🍅SAUSE":
#     #     await souse(message)
#     # elif message.text == "🍟APPETIZERS":
#     #     await appitizer(message)
#     # elif message.text == "🍦🥛ICE CREAM & MILKSHAKE":
#     #     await ice_cream(message)
#     # elif message.text == "🥤ICHIMLIKLAR":
#     #     await drinks(message)
#     # elif message.text == "GENERAL":
#     #     await general(message)
#     # elif message.text == "TOG'ORA":
#     #     await togora(message)
#     # elif message.text == "VAFLI":
#     #     await vafli(message)
#     # elif message.text == "AVA Pizza":
#     #     await ava_pizza(message)
